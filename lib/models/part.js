...
var Part = function Part(part, partList) {
    ...
    this.generateSectionHeatMap = function() {
        ...
        averageDifficulty = numbers.statistic.mean(sectionDifficulties);
        halfSD = numbers.statistic.standardDev(sectionDifficulties)/2;

        sectionDeviance = sectionDifficulties.map(function(value) {
        ...
        return {
            difficulty: sectionDifficulties,
            deviation: sectionDeviance
        };
    };
    ...
    this.processToConsole = function() {
        ...
        console.log(this.generateMeasureHeatMap());
        console.log('- - - - - - - - - - -');
        console.log('Section Difficulties:');
        console.log(this.generateSectionHeatMap());
    };
};
